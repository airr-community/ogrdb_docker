# Modify this file to use the required zenodo toek and id, and the ogrdb password
cd /tmp
...
/usr/local/bin/python /app/zenodo_new_version.py access_tocken deposition_id zonodo_dump.sql 0